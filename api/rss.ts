  ...
  if (address) {
    ...
    const upgradeable = await weightedCalculation(async () => {
      ...
      if (
        ...
        (admin.toLowerCase() === "0x7b502f1aa0f48b83ca6349e1f42cacd8150307a6" && comptroller.toLowerCase() == "0xd4bdcca1ca76ced6fc8bb1ba91c5d7c0ca4fe567") ||
        (admin.toLowerCase() === "0x521cf3d673f4b2025be0bdb03d6410b111cd17d5" && comptroller.toLowerCase() == "0x8583fdff34ddc3744a46eabc1503769af0bc6604")
      ) {
        return 1;
      }
