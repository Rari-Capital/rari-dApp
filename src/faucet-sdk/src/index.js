...
export default class Faucet {
  static FAUCET_POOL_CONTRACT_ADDRESS = "0x0"; // TODO: yea...
  ...
  constructor(web3Provider) {
    ...
    this.contracts = {
      FaucetPool: new this.web3.eth.Contract(faucetPoolAbi, Faucet.FAUCET_POOL_CONTRACT_ADDRESS)
    };
    ...
    this.deployAsset = async function(conf, collateralFactor, reserveFactor, adminFee, options, bypassPriceFeedCheck) {
      ...
      try {
        var [assetAddress, implementationAddress] = await this.deployCToken(conf, true, collateralFactor, reserveFactor, adminFee, options, bypassPriceFeedCheck);
      } catch (error) {
