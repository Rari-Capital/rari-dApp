...
export default class Rari {
    constructor(web3Provider) {
        ...
        for (const currencyCode of Object.keys(this.internalTokens)) this.internalTokens[currencyCode].contract = new this.web3.eth.Contract(erc20Abi, this.internalTokens[currencyCode].address);
        ...
        this.getAllTokens = async function(cacheTimeout = 86400) {
            ...
            return await self.cache.getOrUpdate("allTokens", async function() {
                ...
                for (const token of data.records) if (["DAI", "USDC", "USDT", "TUSD", "BUSD", "bUSD", "sUSD", "SUSD", "mUSD"].indexOf(token.symbol) < 0) {
                    token.contract = new self.web3.eth.Contract(erc20Abi, token.address);
        ...
        this.pools = {};
        this.pools.stable = new StablePool(this.web3, this.getAllTokens);
        this.pools.yield = new YieldPool(this.web3, this.getAllTokens);
        this.pools.ethereum = new EthereumPool(this.web3, this.getAllTokens);
