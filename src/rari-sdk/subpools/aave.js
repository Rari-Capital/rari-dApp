  ...
  async getCurrencyApys() {
    return await this.cache.getOrUpdate("aaveCurrencyApys", async function() {
      ...
      for (var i = 0; i < data.data.reserves.length; i++) {
        if (data.data.reserves[i].symbol === "ETH" && data.data.reserves[i].id !== "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee0x24a42fd28c976a61df5d00d0599c34c4f90748c8") continue;
        apyBNs[
