                ...
                <Tbody>
                    <>
                                ...
                                <Tr>
                                    ...
                                    <Td>
                                        <Row mainAxisAlignment="flex-start" crossAxisAlignment="center">
                                            ...
                                            <SimpleTooltip label={`${balanceRGT} RGT - ${balanceETH} ETH  `} placement="top-start">
                        ...
                        <Tr>
                            ...
                            <Td><Text fontWeight={hasDeposits && "bold"}>{balanceSLP > 0 ? `${apr}%` : null}</Text></Td>
                            <Td><Text fontWeight={hasDeposits && "bold"}>{balanceUSD}</Text></Td>
                            <Td><Text fontWeight={hasDeposits && "bold"}>{earned?.toFixed(2)} RGT</Text></Td>
                            <Td></Td>
                        </Tr>
                    </>
                </Tbody>
