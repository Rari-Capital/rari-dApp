...
import { useMySaffronData, usePrincipal, TranchePool, TrancheRating, useEstimatedSFI, usePrincipalBalance } from 'hooks/tranches/useSaffronData';
...
const Earn = () => {
    ...
    const totalPrincipal: number = totalPrincipalFormatted ? parseFloat(totalPrincipalFormatted?.replace(",", "").replace("$", "")) : 0
                ...
                <Tbody>
                    <>
                        ...
                        <Tr>
                            ...
                            <Td><Text fontWeight={hasDeposits && "bold"} textAlign="right">{smallUsdFormatter(totalPrincipal) ?? 0 }</Text></Td>
                            <Td><Text fontWeight={hasDeposits && "bold"} textAlign="right">{estimatedSFI?.formattedTotalSFIEarned ?? '0 SFI'}</Text></Td>
                            <Td> <Text fontWeight={hasDeposits && "bold"} textAlign="right"></Text></Td>
                        </Tr>
                    </>
                </Tbody>
