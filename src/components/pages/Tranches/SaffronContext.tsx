...
const SaffronStrategyAddress_EPOCH_4 =
  "0x9e0278646fD72318909338Ad87deC7f3464BC434";
const SaffronPoolAddress_EPOCH_4 = "0xbafA231AAac12CE8ba0b23b86669f54a05fC23b5";
...
export const SaffronProvider = React.memo(({ children }) => {
  ...
  const [saffronStrategy, setSaffronStrategy] = useState(() => {
    return new rari.web3.eth.Contract(
      ...
      SaffronStrategyAddress_EPOCH_4
    );
  });
