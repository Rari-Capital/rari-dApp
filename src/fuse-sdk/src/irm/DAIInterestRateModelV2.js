...
export default class DAIInterestRateModelV2 extends JumpRateModel {
    ...
    async init(web3, interestRateModelAddress, assetAddress) {
        ...
        var contract = new web3.eth.Contract(JSON.parse(contracts["contracts/DAIInterestRateModelV2.sol:DAIInterestRateModelV2"].abi), interestRateModelAddress);
        this.dsrPerBlock = Web3.utils.toBN(await contract.methods.dsrPerBlock().call());
        ...
        this.borrows = Web3.utils.toBN(await contract.methods.totalBorrowsCurrent().call());
        this.reserves = Web3.utils.toBN(await contract.methods.totalReserves().call());
