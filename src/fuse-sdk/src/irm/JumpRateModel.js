...
export default class JumpRateModel {
    static RUNTIME_BYTECODE_HASH = "0x59b14f439f54439a4238f78942b585f34e786dd5247650e18f8a99727fa8b7b6";
    ...
    getBorrowRate(utilizationRate) {
        ...
        if (utilizationRate.lte(this.kink)) {
            ...
            const normalRate = this.kink.mul(this.multiplierPerBlock).div(Web3.utils.toBN(1e18)).add(this.baseRatePerBlock);
            const excessUtil = utilizationRate.sub(this.kink);
            return excessUtil.mul(this.jumpMultiplierPerBlock).div(Web3.utils.toBN(1e18)).add(normalRate);
        }
    }
